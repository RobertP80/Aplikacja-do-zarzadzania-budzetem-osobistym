...
Dokładny opis konfiguracji serwera lokalnego (np. XAMPP) znajduje się w pliku [INSTRUKCJA_URUCHOMIENIA.md](INSTRUKCJA_URUCHOMIENIA.md).

**Skrócona instrukcja:**
1. Sklonuj repozytorium do katalogu swojego serwera (np. `htdocs`).
2. Zaimportuj plik bazy danych `.sql` w narzędziu phpMyAdmin.
3. Skonfiguruj poprawne dane dostępowe do bazy w pliku `db.php`.
4. Uruchom aplikację w przeglądarce pod adresem `http://localhost/[nazwa_folderu]/index.php`.
